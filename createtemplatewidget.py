...
from ezmodel.ezmetadatamodel import EzMetadataModel, TemplateModel_V1, TemplateModel
...
if qt_version[1] == 12:
    from generated_5_12.ui_createtemplatewidget import Ui_CreateTemplateWidget
elif qt_version[1] == 15:
    from generated_5_15.ui_createtemplatewidget import Ui_CreateTemplateWidget
