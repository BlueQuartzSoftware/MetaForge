...
from metaforge.newfolderdialogimpl import NewFolderDialogImpl
from metaforge.htremotefilelistmodel import HTRemoteFileListModel

qt_version = PySide2.QtCore.__version_info__
if qt_version[1] == 12:
    from metaforge.generated_5_12.ui_hyperthoughtdialog import Ui_HyperthoughtDialog
elif qt_version[1] == 15:
    from metaforge.generated_5_15.ui_hyperthoughtdialog import Ui_HyperthoughtDialog
