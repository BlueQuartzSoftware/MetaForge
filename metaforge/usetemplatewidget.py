...
from metaforge.uploader import Uploader
import json
...
from metaforge.ezmodel.ezmetadataentry import EzMetadataEntry
from metaforge.ezmodel.ezmetadatamodel import EzMetadataModel, TemplateModel
from metaforge.hyperthoughtdialogimpl import HyperthoughtDialogImpl
from metaforge.qeztablemodel import QEzTableModel
from metaforge.uselistmodel import ListModel
from metaforge.trashdelegate import TrashDelegate
from metaforge.quseeztablemodel import QUseEzTableModel
from metaforge.usefiledelegate import UseFileDelegate
from metaforge.metaforgestyledatahelper import MetaForgeStyleDataHelper
from metaforge.available_parsers_model import AvailableParsersModel
from metaforge.widget_utilities import notify_error_message, notify_no_errors
from metaforge.ht_utilities import ezmodel_to_ht_metadata

qt_version = PySide2.QtCore.__version_info__
if qt_version[1] == 12:
    from metaforge.generated_5_12.ui_usetemplatewidget import Ui_UseTemplateWidget
elif qt_version[1] == 15:
    from metaforge.generated_5_15.ui_usetemplatewidget import Ui_UseTemplateWidget
