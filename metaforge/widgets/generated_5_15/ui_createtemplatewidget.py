...
class Ui_CreateTemplateWidget(object):
    ...
    def retranslateUi(self, CreateTemplateWidget):
        ...
        self.data_file_label.setText(QCoreApplication.translate("CreateTemplateWidget", u"Data File(s):", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.appendCreateTableRowButton.setToolTip(QCoreApplication.translate("CreateTemplateWidget", u"Add a Custom Value that is only going to be used for this upload", None))
#endif // QT_CONFIG(tooltip)
        self.appendCreateTableRowButton.setText("")
#if QT_CONFIG(tooltip)
        self.removeCreateTableRowButton.setToolTip(QCoreApplication.translate("CreateTemplateWidget", u"Add a Custom Value that is only going to be used for this upload", None))
#endif // QT_CONFIG(tooltip)
