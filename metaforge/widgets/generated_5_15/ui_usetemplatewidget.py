...
class Ui_UseTemplateWidget(object):
    def setupUi(self, UseTemplateWidget):
        ...
        self.removeUploadFilesBtn = QPushButton(self.use_frame_3)
        self.removeUploadFilesBtn.setObjectName(u"removeUploadFilesBtn")
        sizePolicy.setHeightForWidth(self.removeUploadFilesBtn.sizePolicy().hasHeightForWidth())
        self.removeUploadFilesBtn.setSizePolicy(sizePolicy)
        self.removeUploadFilesBtn.setMinimumSize(QSize(40, 0))
        self.removeUploadFilesBtn.setMaximumSize(QSize(40, 16777215))
        icon1 = QIcon()
        icon1.addFile(u":/resources/Images/trash_can.png", QSize(), QIcon.Normal, QIcon.Off)
        self.removeUploadFilesBtn.setIcon(icon1)
        self.removeUploadFilesBtn.setIconSize(QSize(18, 18))
        self.removeUploadFilesBtn.setFlat(True)

        self.horizontalLayout_3.addWidget(self.removeUploadFilesBtn)
        ...
        self.useTemplateListView.setLineWidth(1)
        ...
        self.useTemplateListView.setSelectionMode(QAbstractItemView.ExtendedSelection)
        self.useTemplateListView.setSpacing(0)
        self.useTemplateListView.setViewMode(QListView.ListMode)
    ...
    def retranslateUi(self, UseTemplateWidget):
        ...
        self.hyperthoughtLocationButton.setToolTip(QCoreApplication.translate("UseTemplateWidget", u"Allows user to set their API key from HyperThought and set a remote location on the HyperThought server to upload the data files/folders", None))
...
#if QT_CONFIG(tooltip)
        self.hyperthoughtUploadButton.setToolTip(QCoreApplication.translate("UseTemplateWidget", u"Upload all files/folders to the HyperThought server", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.label.setText(QCoreApplication.translate("UseTemplateWidget", u"Files/Folders to be Uploaded:", None))
#if QT_CONFIG(tooltip)
        self.addUploadFilesBtn.setToolTip(QCoreApplication.translate("UseTemplateWidget", u"Add files/folders to the upload list", None))
#endif // QT_CONFIG(tooltip)
        self.addUploadFilesBtn.setText("")
#if QT_CONFIG(tooltip)
        self.removeUploadFilesBtn.setToolTip(QCoreApplication.translate("UseTemplateWidget", u"Removes the selected rows from the table", None))
#endif // QT_CONFIG(tooltip)
        self.removeUploadFilesBtn.setText("")
#if QT_CONFIG(tooltip)
        self.useTemplateListView.setToolTip(QCoreApplication.translate("UseTemplateWidget", u"This is the list of files/folders that will be tagged with the metadata in the table on the right and uploaded to HyperThought.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.useTemplateTableView.setToolTip("")
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.clearUseButton.setToolTip(QCoreApplication.translate("UseTemplateWidget", u"Reset all 'Use Template' input fields. All fields will be reset to an empty state.", None))
#endif // QT_CONFIG(tooltip)
