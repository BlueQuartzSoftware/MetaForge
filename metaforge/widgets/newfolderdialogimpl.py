...
if qt_version[1] == 12:
    from metaforge.widgets.generated_5_12.ui_newfolderdialog import Ui_NewFolderDialog
elif qt_version[1] == 15:
    from metaforge.widgets.generated_5_15.ui_newfolderdialog import Ui_NewFolderDialog
