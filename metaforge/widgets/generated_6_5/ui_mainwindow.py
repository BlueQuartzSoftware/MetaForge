...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionSave_Template_As = QAction(MainWindow)
        self.actionSave_Template_As.setObjectName(u"actionSave_Template_As")
        self.actionSave_Package_As_2 = QAction(MainWindow)
        self.actionSave_Package_As_2.setObjectName(u"actionSave_Package_As_2")
        ...
        self.menuFile.addAction(self.actionSave_Template_As)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionSave_Package)
        self.menuFile.addAction(self.actionSave_Package_As_2)
        self.menuFile.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSave_Template_As.setText(QCoreApplication.translate("MainWindow", u"Save Template As", None))
#if QT_CONFIG(shortcut)
        self.actionSave_Template_As.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+Shift+S", None))
#endif // QT_CONFIG(shortcut)
        self.actionSave_Package_As_2.setText(QCoreApplication.translate("MainWindow", u"Save Package As", None))
