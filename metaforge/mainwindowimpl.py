...
from metaforge.aboutdialogimpl import AboutDialogImpl
from metaforge.metaforge_preferences import MetaForgePreferencesDialog, MetaForgePreferences
...
if qt_version[1] == 12:
    from metaforge.generated_5_12.ui_mainwindow import Ui_MainWindow
elif qt_version[1] == 15:
    from metaforge.generated_5_15.ui_mainwindow import Ui_MainWindow
